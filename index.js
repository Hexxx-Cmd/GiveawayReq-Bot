                ...
                if (args[5]) {
                                ...
                                if (winners < 1 || winners > 10) {
                                    ...
                                    if (serverid !== "none") {
                                        ...
                                        if (!server) {
                                            ...
                                            requirements.push(`Join the server: [${server.name}](${invite}) (${server.id})`);
                                        };
                                    };
                                    if (rolevar !== "none") {
                    ...
                    message.channel.send(
                        new Discord.MessageEmbed()
                            .setTitle('Giveaway')
                            .setColor("RED")
                            .setDescription(`Incorrect usage. Please use \`${settings.bot.prefix}giveaway <time> <winners> <server id or "none"> <role id or "none"> <message count number or "none"> <prize>\` instead.`)
                    );
                };
            } else {
                message.channel.send(
                    new Discord.MessageEmbed()
                        .setTitle('Giveaway')
                        .setColor("RED")
                        .setDescription(`In order to use this command, you must run the command \`${settings.bot.prefix}giveaway <time> <winners> <server id or "none"> <role id or "none"> <message count number or "none"> <prize>\`.`)
                );
            };
        } else if (cmd == "reroll") {
            if (args[0] && !args[1]) {
